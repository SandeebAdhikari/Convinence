...
public class CategoriesAccessories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.Adapter<RecycleViewAdapter.MyViewHolder> mAdapter = new RecycleViewAdapter(itemsList, CategoriesAccessories.this);
    ...
    private void fillItemsList() {
        Items i0 = new Items(1, "Globe", "34.99",R.drawable.globe);
        Items i1 = new Items(2, " Color Pencil", "$44.99",R.drawable.colorpencil);
        Items i2 = new Items(3, "Light Pen", "$49.99",R.drawable.lightpen);
        Items i3 = new Items(4, "Compass", "$34.99",R.drawable.campass);
        Items i4 = new Items(5, "Paper Click", "$64.99",R.drawable.k8);
        Items i5 = new Items(6, "Pencil", "$29.99",R.drawable.pencil);
        Items i6 = new Items(7, "Scale", "$38.99",R.drawable.ruler);
        Items i7 = new Items(8, "Pen", "$22.99",R.drawable.pen);
        Items i8 = new Items(9, "Scissor", "$31.99",R.drawable.scissor);
        Items i9 = new Items(10, "Eraser", "$69.99",R.drawable.eraser);
